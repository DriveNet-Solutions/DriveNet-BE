"""
URL configuration for drivenet_be project.
...
urlpatterns = [
    ...
    path('api/showEmployee/', showEmployeeView.as_view(),name ='showEmployee'),
    path('api/addEmployee/', addEmployeeView.as_view(), name='addEmployee'),
